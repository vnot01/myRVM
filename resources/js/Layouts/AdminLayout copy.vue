...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900 flex">
            ...
            <aside class="w-64 bg-white dark:bg-gray-800 shadow-md hidden sm:flex sm:flex-col transition-all duration-300 sm:translate-x-0">
                ...
                <nav class="flex-grow p-4 space-y-1">
                    ...
                    <ResponsiveNavLink :href="route('admin.dashboard')" @click="showingNavigationDropdown = false" v-if="page.props.auth.user.role === 'Admin'">
                        <a href="#" class="flex items-center p-2 text-gray-400 rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 group">
                          <svg class="mr-3 h-6 w-6 text-gray-400 group-hover:text-gray-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                              <path d="M16.975 11H10V4.025a1 1 0 0 0-1.066-.998 8.5 8.5 0 1 0 9.039 9.039.999.999 0 0 0-1-1.066h.002Z"/>
                              <path d="M12.5 0c-.157 0-.311.01-.565.027A1 1 0 0 0 11 1.02V10h8.975a1 1 0 0 0 1-.935c.013-.188.028-.374.028-.565A8.51 8.51 0 0 0 12.5 0Z"/>
                          </svg>
                          <span class="mr-3 h-6 w-6 text-gray-400 group-hover:text-gray-300" aria-hidden="true">Dashboard</span>
                        </a>
                    </ResponsiveNavLink>
                    <!-- Contoh untuk ResponsiveNavLink di Sidebar Mobile -->
                    <ResponsiveNavLink :href="route('admin.rvms.index')" @click="showingNavigationDropdown = false" v-if="page.props.auth.user.role === 'Admin'">
                      <a href="#" class="flex items-center p-2 text-gray-400 rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 group">
                          <svg class="w-[27px] h-[27px] text-gray-400 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                          ...
                          <span class="flex-1 ms-3 text-gray-400 group-hover:text-gray-300 whitespace-nowrap">Manajemen RVM</span>
                        </a>
                    </ResponsiveNavLink>
                    <!-- Contoh untuk ResponsiveNavLink di Sidebar Mobile -->
                    <ResponsiveNavLink :href="route('admin.users.index')" @click="showingNavigationDropdown = false" v-if="page.props.auth.user.role === 'Admin'">
                        <a href="#" class="flex items-center p-2 text-gray-400 rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 group">
                          ...
                          <span class="flex-1 ms-3 text-gray-400 group-hover:text-gray-300 whitespace-nowrap">Manajemen User</span>
                        </a>
                    </ResponsiveNavLink>
                </nav>
            </aside>
